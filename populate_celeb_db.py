...
def populate():
	for key,val in celeb_dict.iteritems():
		add_celeb(input_name=key, input_dob=val)
	# Print out what we have added to the user.
	for c in Celeb.objects.all():
			print "{0}".format(str(c))

def add_celeb(input_name, input_dob, input_number_of_hits = 0):
	c = Celeb.objects.get_or_create(name=input_name, dob = input_dob)
	#c.save()
	return c

# Start execution here!
if __name__ == '__main__':
	print "Starting Celeb population script..."
	populate()